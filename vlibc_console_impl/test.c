...
int main(int argc, char *argv[]) {
	...
	vlibc_fill(&canvas, VLIBC_RGBA_NULL, vlibc_nullptr, VLIBC_SHADER_DATA_NULL);
	...
	vlibc_filled_figure(&canvas, (vlibc_rgba){255, 255, 255, 255}, (vlibc_vec2d){0, 0}, vertices, 7, &frag_shader, VLIBC_SHADER_DATA_NULL);
